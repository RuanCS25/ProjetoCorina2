    ...
    public partial class Geral : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistroAusencias", x => x.RegistroAusenciaId);
                    table.ForeignKey(
                        name: "FK_RegistroAusencias_Alunos_AlunoId",
                        column: x => x.AlunoId,
                        principalTable: "Alunos",
                        principalColumn: "AlunoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegPresencas", x => x.RegPresencaId);
                    table.ForeignKey(
                        name: "FK_RegPresencas_Alunos_AlunoId",
                        column: x => x.AlunoId,
                        principalTable: "Alunos",
                        principalColumn: "AlunoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistroAusencias_AlunoId",
                table: "RegistroAusencias",
                column: "AlunoId");

            migrationBuilder.CreateIndex(
                name: "IX_RegPresencas_AlunoId",
                table: "RegPresencas",
                column: "AlunoId");
        }
